...
<body>
    ...
    <main class="container">
        ...
        <!-- How It Works -->
        <section style="background: linear-gradient(135deg, #0A2F5F 0%, #1a4d7d 100%); color: white; padding: 60px 40px; border-radius: 12px; text-align: center; margin-bottom: 60px;">
